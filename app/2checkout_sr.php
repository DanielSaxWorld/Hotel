...
<body onLoad="document.getElementById('country').focus();">
	<form action="2savesales_sr.php" method="post">
		<div id="ac">
			<center>
...
<input type="number" name="cash" autofocus placeholder="Amount Tendered" value="<?php echo $_GET['total']; ?>" style="width: 268px; height:35px;  margin-bottom: 15px;" required /><br>
			...
			?>
				...
				<select name="cname" style="width: 268px; height: 35px; margin-bottom: 15px" required="required">
                                    <option value="">--Select Sales Rep--</option>
                                    <?php
                                    include('db_conn.php');
                                    $sql2 = "SELECT * FROM `workers` WHERE staff_designation='Sales Rep' ORDER by id ASC";
			...
			?><button class="btn btn-danger btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large"></i> Save SALES</button>
			</center>
		</div>
	</form>
</body>
