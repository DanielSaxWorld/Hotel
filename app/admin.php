...
<head>
    ...
    <!--<meta http-equiv="refresh" content="<?php //echo $sec ?>;URL='<?php //echo $pagerefresh?>'">-->
...
<body>
    ...
    <?php include 'menus.php'; ?>
                ...
                <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-sm-12">
                        <h2>Welcome <strong><?php echo $session_fullname; ?></strong> to <img src="img/tourafrica.png" height="150"> <strong>ADMIN DASHBOARD</strong> </h2>



<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"> <div class="col-lg-3">
            ...
            <a href="bulksales.php?id=cash&invoice=<?php echo $finalcode2 ?>"> <div class="col-lg-3">
...
$sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%y') as NEWDate FROM `sales` WHERE date='$todayDATE' AND `invoice_number` LIKE '%RT%' ORDER by transaction_id DESC LIMIT 6";
...
?>
                                            ...
                                            <td class="text-navy"><i class="fa fa-clock-o"></i> <?php echo $row['NEWDate']." - ".date('h:i:s a', strtotime($row['time']));; ?></td>                                                <td class="text-navy"><?php echo $row['cashier']; ?></td>
                            ...
                            <ul class="dropdown-menu">
                             ...
                             <li><a data-toggle="modal" href="preview2.php?invoice=<?php echo $row['invoice_number']; ?>">Print Receipt</a></li>
                             <li><a data-toggle="modal" href="sales.php?id=cash&invoice=<?php echo $row['invoice_number']; ?>">Sales Order</a></li>
                             <li><a data-toggle="modal" href="deletesalesorder2.php?transaction_id=<?php echo $row['transaction_id']; ?>" onclick="return confirm('ARE YOU SURE TO REVOKE THIS SALES!'); ">Revoke</a></li>
...
include('db_conn.php');
$todayDATE = date("Y-m-d");
$sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%y') as NEWDate FROM `sales` WHERE date='$todayDATE' AND `invoice_number` LIKE '%WS%' ORDER by transaction_id DESC LIMIT 6";
$result = mysqli_query($conn, $sql);
if (mysqli_num_rows($result) > 0) {
 while($row = mysqli_fetch_array($result)) {
...
?>
                            ...
                            <ul class="dropdown-menu">
                             ...
                             <li><a data-toggle="modal" href="bulkpreview2.php?invoice=<?php echo $row['invoice_number']; ?>">Print Receipt</a></li>
                             <li><a data-toggle="modal" href="bulksales.php?id=cash&invoice=<?php echo $row['invoice_number']; ?>">Sales Order</a></li>
                             <li><a data-toggle="modal" href="deletesalesorder2.php?transaction_id=<?php echo $row['transaction_id']; ?>" onclick="return confirm('ARE YOU SURE TO REVOKE THIS SALES!'); ">Revoke</a></li>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
				...
				toastr.success('Manager Dashboard', 'Welcome to <?php echo $session_business_name; ?>');
