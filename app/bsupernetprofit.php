...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Bar Net Profit</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="25"> <?php echo $session_business_name; ?> | Bar Net Profit Report</h5>
...
<?php
 $sql = "SELECT *, sum(amount) as TOTAL_amountSALES FROM ssales_order WHERE `date` BETWEEN '$datefrom' AND '$dateto'";
...
<?php
 $sql = "SELECT *, sum(profit) as TOTAL_profitSALES FROM ssales_order WHERE `date` BETWEEN '$datefrom' AND '$dateto'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
...
<?php
 $sql = "SELECT *, sum(amount) as TOTAL_opexAMOUNT FROM sopex WHERE `opex_date` BETWEEN '$datefrom' AND '$dateto'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
