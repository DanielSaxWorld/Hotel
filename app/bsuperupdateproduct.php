...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Bar Update Product</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5><img src="img/hgl_logo.fw.png" height="30"> Bar Update Product </h5>
...
$sql = "UPDATE sproducts SET product_code='$code', gen_name='$stock', product_name='$name', o_price='$o_price', price='$price', profit='$profit', qty='$totalstock', date_arrival='$date_arrival' WHERE product_id=$_REQUEST[product_id]";
...
$num=mysqli_insert_id($conn);
	...
	echo "<script>alert('Bar Product Successfully Updated')
...
document.getElementById("profit2").value=sum2;
                    ...
                    <div class="col-lg-9">
                    <input type="text" name="o_price" step="any" id="o_price2" value="<?php echo $row['o_price']; ?>" onkeyup="sum()" placeholder="Purchase Price" class="form-control" required>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                    <input type="text" name="price" step="any" id="price2" value="<?php echo $row['price']; ?>" onkeyup="sum()" placeholder="Selling Price" class="form-control" required>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                    <input type="text" name="profit" step="any" readonly id="profit2" value="<?php echo $row['profit']; ?>"  placeholder="Profit" class="form-control" required>
                    </div>
                    </div>
