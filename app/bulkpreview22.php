    ...
    <?php include 'menus2.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="bulksales2.php?id=cash&invoice=<?php echo $finalcode2 ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Wholesales</button></a>
                         ...
                         <a <?php echo "href='preview3_printws.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-danger"><i class="fa fa-print"></i> XP-90 </a>
