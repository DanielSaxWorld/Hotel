...
var room_price = document.getElementById("price").value;
...
document.getElementById("total_amount").value=totalamount;
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input id="name" name="arrival_date" id="checkin_date" onchange="nightcal()" placeholder="Arrival Date" type="date" class="form-control" required title="Pick Arrival Date">
                                            </div>

                                            <div class="form-group col-lg-6">
                                                <label>Expected Checkout Date & Time *</label>
                                                <input id="name" name="checkout" id="checkout_date" onchange="nightcal()"  type="date" class="form-control" required title="Pick Checkout Date & Time">
                                            </div>
...
$('#room-list').on('change', function(){
	...
	success: function(result){
     ...
     <div class="form-group col-lg-6">
              ...
              <input type="number" step="any" id="nights" onkeyup="nightcal()" readonly  placeholder="Number of Night(s)"  class="form-control" title="night" name="night" required>
          </div>
