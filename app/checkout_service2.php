...
<body onLoad="document.getElementById('country').focus();">
	<form action="savesales_service2.php" method="post">
		<div id="ac">
			<center>
			...
			<center>
				...
				<input type="number" name="cash" placeholder="Amount Received" style="width: 268px; height:35px;  margin-bottom: 15px;" required /><br>
