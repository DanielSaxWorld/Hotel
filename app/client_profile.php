            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="30" style="margin-top:-5px"> <?php echo $row['fullname']; ?> | <?php echo $row['uin']; ?> | GUEST HISTORY</h5>
...
th { text-align:right}
                           ...
                           <td rowspan="2"><img src="client_id/<?php echo $row['valid_id']; ?>" height="80" class="img-shadow"></td>
                           </tr>
