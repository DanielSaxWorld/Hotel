    ...
    <?php include 'menus3.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <a href="distributor.php">Dashboard</a>
                        </li>
                        <li class="active">
                            <strong>Wholesale Receipt</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <div class="title-action">
                    <a href="bulksales3.php?id=cash&invoice=<?php echo $finalcode2 ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Wholesales</button></a>

						 <a <?php echo "href='dbulkpreview2_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> HP A4 </a>

                         <a <?php echo "href='dpreview3_printws.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-danger"><i class="fa fa-print"></i> XP-90 </a>
