...
$sql = "UPDATE pro_distributor SET product_code='$code', gen_name='$stock2', product_name='$name', o_price='$o_price', price='$price', wsprice='$wsprice', qty='$totalstock', date_arrival='$date_arrival' WHERE product_id=$_REQUEST[product_id]";
