...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Restuarant Opex</title>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php
include('db_conn.php');
$sql = "SELECT *, DATE_FORMAT(opex_date, '%a-%d-%b-%Y') as Newopexdate FROM `dopex` ORDER by id ASC  LIMIT 30";
                    ...
                    <tr class="gradeA">
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a <?php echo "href='ddelete_record.php?id=".$row['id']."' title='Delete Opex'"; ?> onclick="return confirm('ARE YOU SURE TO DELETE THIS RECORD!'); ">Delete</a></li>
