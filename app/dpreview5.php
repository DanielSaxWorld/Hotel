...
<head>
    ...
    <title><?php echo $session_business_name; ?> | SUPERMARKET Sales Receipt</title>
    ...
    <?php include 'menus5.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <a href="supermarket.php">Dashboard</a>
                        </li>
                        <li class="active">
                            <strong>SUPERMARKET Sales Receipt</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <div class="title-action">
                    <a href="sales5.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Sales</button></a>



						 <a <?php echo "href='dpreview5_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> XP-90 </a>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <table class="table table-striped">
                             <thead>
                             <tr>
                             <td align="center" colspan="5"><h3>SUPERMARKET SALES RECEIPT</h3></td>
                             </tr>
