...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Eatery Opex by Purpose</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="25"> <?php echo $session_business_name; ?> | Eatery Opex Report by Purpose</h5>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Eatery_OpexbyPurpose'},
                    {extend: 'pdf', title: 'Eatery_OpexbyPurpose'},
