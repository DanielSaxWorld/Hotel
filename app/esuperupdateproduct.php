...
$sql = "UPDATE pro_distributor SET product_code='$code', gen_name='$stock', product_name='$name', o_price='$o_price', price='$price', profit='$profit', qty='$totalstock', date_arrival='$date_arrival' WHERE product_id=$_REQUEST[product_id]";
...
$num=mysqli_insert_id($conn);
	...
	echo "<script>alert('Eatery Product Successfully Updated')
