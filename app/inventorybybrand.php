...
$sql = "SELECT *, DATE_FORMAT(date_arrival, '%a-%d-%b-%Y') as Newpurchasedate FROM `products` WHERE `product_code`='$product_code' AND `date_arrival` BETWEEN '$datefrom' AND '$dateto'";
