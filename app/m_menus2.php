<div id="wrapper">
    ...
    <li class="active">
    <a href="receptionist.php"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span> <span class="fa arrow"></span></a>
    <ul class="nav nav-second-level">
       <li class="active"><a href="receptionist.php">Go to Dashboard</a></li>
       <li><a <?php echo "href='guest_profile2.php?uin=".$row['uin']."' title='Guest Profile'"; ?>>Guest Profile</a></li>
