...
$finalcode = 'MHB-' . $randtime.$randday.$rand;
?>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="bar.php"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                           <li><a href="bar.php">Go to Dashboard</a></li>
...
<li class="active"><a href="sales4.php?id=cash&invoice=<?php echo $finalcode ?>">Add Sales</a>  </li>
    <li style="text-align: center">-------------Reports--------------</li>

                            <li><a data-toggle="modal" data-target="#sales4bydate">Report by date</a></li>
							<li><a data-toggle="modal" data-target="#sales4byproduct">Report by Product</a></li>
                        </ul>
                    </li>
        ...
        <div class="modal inmodal col-xs-12" id="salesbydate" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <h3><i class="fa fa-shopping-cart"></i> Sales Report by Date</h3><hr>
                    ...
                    <input type="submit" name="salesbydate" value="Generate Report" class="btn btn-danger">
                            ...
                            <!--Sales2 by Date-->
        <div class="modal inmodal col-xs-12" id="sales4bydate" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated flipInY">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          <h3><i class="fa fa-shopping-cart"></i> Sales Report by Date</h3><hr>
                    <form class="form-horizontal" method="post" action="sales4bydate.php">
                    ...
                    <div class="col-lg-12">
                    <input type="submit" name="sales4bydate" value="Generate Report" class="btn btn-danger">
                    </div>
                    </form>
			...
			<!--Sales2 by Product-->
        <div class="modal inmodal col-xs-12" id="sales4byproduct" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated flipInY">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          <h3><i class="fa fa-shopping-cart"></i> Sales Report by Product</h3><hr>
                    <form class="form-horizontal" method="post" action="sales4byproduct.php">
                    ...
                    <div class="col-lg-12">
                    <input type="submit" name="sales4byproduct" value="Generate Report" class="btn btn-danger">
                    </div>
                    </form>
