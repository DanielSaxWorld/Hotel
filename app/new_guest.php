...
$check=mysqli_query($conn, "SELECT * FROM guest WHERE fullname='$fullname' OR phone='$phone' OR email='$emailreg' ");
...
$sql="INSERT INTO guest (uin, fullname, phone, email, gender, civic_status, vehicle_type, plate_no, vehicle_colour, identification, nok_name, nok_phone, valid_id) VALUES ('$uin','$fullname','$phone','$emailreg','$gender','$civic_status','$vehicle_type','$plate_no','$vehicle_colour','$identification','$nok_name','$nok_phone','$valid_id')";
...
echo "<script>alert('NEW Guest - $fullname - Record Successfully Added')
	location.href='check_in.php?uin=".$_REQUEST['uin']."'</script>";
}
}
    }
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input id="name" autofocus name="fullname" placeholder="Fullname" type="text" class="form-control required">
                                            </div>
                                            <div class="form-group col-lg-6">
...
<img id="blah"  />
 ...
 <div class="form-group col-lg-6">
<input type="submit" name="newguest" value="Submit" class="btn btn-primary block m-b">
</div>
