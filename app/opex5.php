...
<head>
    ...
    <title><?php echo $session_business_name; ?> | SUPERMARKET Opex</title>
...
<body>
   ...
   <?php  include 'menus5.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><img src="img/hgl_logo.fw.png" height="30"> <strong>SUPERMARKET OPERATING EXPENSIS</strong></h2>
                    <ol class="breadcrumb">
                        <li>
                    ...
                    <tr class="gradeA">
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a <?php echo "href='ddelete_record5.php?id=".$row['id']."' title='Delete Opex'"; ?> onclick="return confirm('ARE YOU SURE TO DELETE THIS RECORD!'); ">Delete</a></li>
