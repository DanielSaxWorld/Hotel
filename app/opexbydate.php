...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Opex by Date</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="25"> <?php echo $session_business_name; ?> | Opex Report by Date</h5>
...
$sql = "SELECT *, DATE_FORMAT(opex_date, '%a-%d-%b-%Y') as Newopexdate FROM `opex` WHERE `opex_date` BETWEEN '$datefrom' AND '$dateto'";
...
?>
                    ...
                    <tbody>
<?php  
 $sql = "SELECT *, sum(amount) as TOTAL_amount FROM opex WHERE `opex_date` BETWEEN '$datefrom' AND '$dateto'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
