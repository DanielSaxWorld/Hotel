    ...
    <?php include 'menus2.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="services3.php?id=cash&invoice=<?php echo $finalcode2 ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Services</button></a>
                        <a <?php echo "href='previewservice2_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-danger"><i class="fa fa-print"></i> Print Receipt </a>
