...
include('connect.php');
$result = $db->prepare("SELECT * FROM sales_sr WHERE invoice_number= :userid");
...
<body>
    ...
    <?php include 'menus_sr.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    <h2> <img src="img/hgl_logo.fw.png" height="35"> <strong><?php echo $session_business_name; ?> | Sales Receipt</strong></h2>
                    <ol class="breadcrumb">
                        <li>
                ...
                <div class="col-lg-4">
                    ...
                    <a href="sales_sr.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Sales</button></a>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <table class="table table-striped">
                             <thead>
                             <tr>
                             <td align="center" colspan="5"><h3>SALES RECEIPT</h3></td>
                             </tr>
                            ...
                            <tbody>
                             <?php
					$id=$_GET['invoice'];
					$result = $db->prepare("SELECT * FROM sales_order_sr WHERE invoice= :userid");
