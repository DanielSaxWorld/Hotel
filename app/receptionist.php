    ...
    <?php include 'menus6.php'; ?>
                ...
                <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-sm-12">
                        ...
                        <a href="new_guest2.php"> <div class="col-lg-6">
            ...
            <a href="guest_view2.php"> <div class="col-lg-6">
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <table class="table table-hover no-margins">
                                            ...
                                            <?php
include('db_conn.php');
$sql = "SELECT * FROM `active_check_in` ORDER by arrival_date LIMIT 30";
...
?>
                        ...
                        <td><?php echo date('d-M-Y h:i:s a', strtotime($row['checkout'])); ?></td>
                            ...
                            <ul class="dropdown-menu">
                             ...
                             <li><a data-toggle="modal" href="check_out22.php?lodge_id=<?php echo $row['lodge_id']; ?>" onclick="return confirm('ARE YOU SURE TO CHECKOUT THIS GUEST!'); ">Check Out Guest</a></li>
