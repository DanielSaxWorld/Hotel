...
<table class="table table-bordered" id="resultTable" data-responsive="table">
	...
	<tbody>
			...
			<td width="90"><a href="delete2.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>"><button class="btn btn-xs btn-warning"><i class="fa fa-times"></i> Cancel </button></a></td>
			</tr>
			<?php
				}
			?>
...
<a rel="facebox" href="checkout2.php?pt=<?php echo $_GET['id']?>&invoice=<?php echo $_GET['invoice']?>&total=<?php echo $fgfg ?>&totalprof=<?php echo $asd ?>&cashier=<?php echo $session_fullname?>"><button class="btn btn-primary btn-large btn-block"><i class="fa fa-save (alias)"></i> SAVE</button></a>
