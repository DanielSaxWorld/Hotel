...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Sales by Product</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="25"> <?php echo $session_business_name; ?> | Sales Report by Product</h5>
...
?>
                    ...
                    <tbody>
<?php
 $sql = "SELECT *, sum(amount) as TOTAL_amount, sum(profit) as TOTAL_profit, sum(qty) as TOTAL_qty FROM sales_order WHERE `date` BETWEEN '$datefrom' AND '$dateto' AND product_code='$productcode' ";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
