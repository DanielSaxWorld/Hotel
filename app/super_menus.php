    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-university"></i> <span class="nav-label">GUEST</span><span class="fa arrow"></span></a>
                ...
                <li>
                    <a href="#"><i class="fa fa-pie-chart"></i> <span class="nav-label">ROOM</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    <a href="#"><i class="fa fa-user"></i> <span class="nav-label">Online Booking</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">

						<li><a href="superaccountlist.php">View Booking</a></li>
...
<div class="modal inmodal col-xs-12" id="addroom" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-header">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                        ...
                        if (isset($_REQUEST['addroom'])) {
                            ...
                            $capacity = trim(addslashes($_REQUEST['capacity']));
                            $description = trim(addslashes($_REQUEST['description']));

                            $photos = $_FILES["photos"]['name'];
                            $target="rooms/";
                            $target=$target.$_FILES["photos"]['name'];

                    if(move_uploaded_file($_FILES["photos"]['tmp_name'], $target)>0){


							//Check for duplicate record in database before inserting New Record
    $check=mysqli_query($conn, "SELECT * FROM room WHERE room_name='$room_name'");
    $checkrows=mysqli_num_rows($check);
   ...
   if($checkrows>0) {
    ...
    $sql1 = "INSERT INTO room_price (room_id, room_name, price) VALUES ('$room_id','$room_name','$price')";
                            ...
                            $sql2 = "INSERT INTO room (room_id, room_name, price, capacity, `description`, photos) VALUES ('$room_id','$room_name','$price','$capacity','$description','$photos')";
...
location.href='roomlist.php'</script>";
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="room_id" value="<?php echo $ID; ?>" readonly placeholder="Enter Room ID" class="form-control" required="required">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="capacity" placeholder="Enter Capacity" class="form-control" required="required">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-3 control-label">Room Photos: (jpeg, png only)</label>
                            <div class="col-lg-9">
                                <input type="file" multiple accept=".jpeg,.jpg,.png,.PNG,.JPG,.JPEG" name="photos" class="form-control" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <textarea name="description" placeholder="Short Description" class="form-control" id="" cols="30" rows="5"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <input type="submit" name="addroom" onclick="return confirm('Are you sure to Add this ROOM')" value="Add New Room" class="btn btn-danger">
                        </div>
                    </form>
