    ...
    <?php include 'menus2.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="superbulksales2.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Sales</button></a>
                        <a <?php echo "href='superbulkpreview2_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Receipt </a>
