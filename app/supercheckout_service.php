...
<body onLoad="document.getElementById('country').focus();">
	<form action="supersavesales_service.php" method="post">
		<div id="ac">
			<center>
				<h4><i class="icon icon-money icon-large"></i> Cash Tendered</h4>
			</center>
			<hr>
			...
			<center>
				...
				<input type="number" name="cash" placeholder="Cash Tendered" style="width: 268px; height:35px;  margin-bottom: 15px;" required /><br>
			...
			?>
				...
				<input type="text" name="imei" placeholder="Customer Phone No" style="width: 268px; height:35px;  margin-bottom: 15px;" /><br>
			<?php
				}
			?><button class="btn btn-danger btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large"></i> Save</button>
			</center>
		</div>
	</form>
</body>
