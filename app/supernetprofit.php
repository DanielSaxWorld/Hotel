...
while($row = mysqli_fetch_array($result)) {
   ...
   echo	'
   <tr>
<th colspan="2">TOTAL GROSS EATERY SALES: ' . "<span class='value-$TOTAL_amountESALES'>&#8358;" . number_format($row['TOTAL_amountESALES'], 2) . "</span>" .'</th>
</tr>';
...
<tr>
<th colspan="2">EATERY GROSS PROFIT: ' . "<span class='value-$TOTAL_profitESALES'>&#8358;" . number_format($row['TOTAL_profitESALES'] , 2) . "</span>" .'</th>
</tr>';
