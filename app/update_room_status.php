...
$password = "mariston@2022";
    ...
    $message= "Welcome ".$fullname." to Mariston Hotel & Suites, we hope you will enjoy your stay in our ".$room_name." Room with Logde ID: ".$lodge_id.". Thanks!";
...
if($result2 && $result3) {
    ...
    location.href='receipt.php?lodge_id=".$lodge_id."'</script>";
} else {
