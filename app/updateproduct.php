...
$sql = "UPDATE products SET product_code='$code', gen_name='$stock2', product_name='$name', o_price='$o_price', price='$price', wsprice='$wsprice', qty='$totalstock', date_arrival='$date_arrival', reorder_level='$reorder_level' WHERE product_id=$_REQUEST[product_id]";
...
document.getElementById("totalstock").value=sum2stock;
                    ...
                    <div class="col-lg-9">
                    <input type="date" name="date_arrival" value="<?php echo $row['date_arrival']; ?>" placeholder="Purchase Date" class="form-control" required>
                    </div>
                    </div>
