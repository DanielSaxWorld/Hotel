...
<head>
    ...
    <title>HGL GUEST HOUSE | GUEST List</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>HGL GUEST HOUSE | Guest List</h5>
                    ...
                    <tr class="gradeA">
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a <?php echo "href='guest_profile2.php?uin=".$row['uin']."' title='Guest Profile'"; ?>>Profile</a></li>
