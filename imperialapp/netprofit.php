...
<head>
    ...
    <title>Net Profit Report by Date</title>
...
$sql = "SELECT * FROM `opex` WHERE `opex_date` BETWEEN '$datefrom' AND '$dateto'";
...
?>
                    ...
                    <tbody>
<?php
$sql2 = "SELECT *, sum(amount) as TOTALExpenses FROM opex WHERE `opex_date` BETWEEN '$datefrom' AND '$dateto'";
...
if (mysqli_num_rows($result2) > 0) {
	...
	$_REQUEST['TOTALExpenses'] = $row ['TOTALExpenses'];
?>

<tr>
<th colspan="2" style=" text-align:right">GRAND TOTAL</th>
    <th colspan="2">&#8358;<?php echo number_format($_REQUEST['TOTALExpenses'], 2);
