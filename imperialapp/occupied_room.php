...
<body>
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">Occupied Rooms </div>
        <div class="right">
    ...
    <div id="appCapsule">
        ...
        <div class="listview-title mt-2">Occupied Rooms || <?php echo $session_business_name; ?></div>
        <ul class="listview image-listview inset">
        <?php
include('db_conn.php');
$sql = "SELECT * FROM `room` WHERE room_status='Occupied' ORDER by id ASC";
