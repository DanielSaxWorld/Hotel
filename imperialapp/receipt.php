    ...
    <div id="appCapsule" class="full-height">
        ...
        <div class="section mt-2 mb-2">
            ...
            <ul class="listview flush transparent simple-listview no-space mt-3">
                ...
                <li>
                    <strong>Lodge ID</strong>
                    <span><?php echo $row['lodge_id']; ?></span>
                </li>
                <li>
                ...
                <li>
                    <strong>No of Night(s)</strong>
                    <span><?php echo $row['night']; ?></span>
                </li>
                <li>
                    <strong>Check-In Date</strong>
                    <span><?php echo date('jS-M-Y', strtotime($row['arrival_date'])); ?></span>
                </li>
                <li>
                    <strong>Check-Out Date</strong>
                    <span><?php echo date('jS-M-Y', strtotime($row['checkout'])); ?></span>
                </li>

                <li>
                    <strong>No of Guest</strong>
                    <span><?php echo $row['nofguest']; ?></span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <h3 class="m-0">&#8358;<?php echo number_format($row['total_amount'], 2); ?></h3>
                </li>
            </ul>
