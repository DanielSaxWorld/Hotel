...
if(isset($_REQUEST['transaction_id'])){
    $sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as New_withdrawal_date FROM transactions WHERE transaction_id='$_REQUEST[transaction_id]'";
...
<head>
    ...
    <title><?php echo $row['fullname']; ?> || Withdrawal Receipt</title>
    ...
    <div id="appCapsule" class="full-height">
        ...
        <div class="section mt-2 mb-2">
            ...
            <div class="listed-detail mt-3">
                ...
                <h3 class="text-center mt-2">Withdrawal Made</h3>
            </div>
            ...
            <ul class="listview flush transparent simple-listview no-space mt-3">
                ...
                <li>
                    <strong>Date</strong>
                    <span><?php echo $row['New_withdrawal_date']; ?></span>
                </li>
                <li>
