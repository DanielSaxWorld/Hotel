...
<script type="text/javascript">
  jQuery(document).ready(function($) {
    ...
    <title><?php echo $session_business_name; ?> | Wholesales</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <form action="bulkincoming2.php" method="post" >
...
<table class="table table-bordered" id="resultTable" data-responsive="table">
	...
	<tbody>
			...
			<td width="90"><a href="bulkdelete2.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>"><button class="btn btn-xs btn-warning"><i class="fa fa-times"></i> Cancel </button></a></td>
			</tr>
			<?php
				}
			?>
...
<a rel="facebox" href="bulkcheckout2.php?pt=<?php echo $_GET['id']?>&invoice=<?php echo $_GET['invoice']?>&total=<?php echo $fgfg ?>&totalprof=<?php echo $asd ?>&cashier=<?php echo $session_fullname?>"><button class="btn btn-primary btn-large btn-block"><i class="fa fa-save (alias)"></i> SAVE</button></a>
