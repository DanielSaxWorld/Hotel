...
$password = "enpre@2022";
    ...
    $message= "Dear ".$fullname.", your room has been changed to ".$room_name." with Logde ID: ".$lodge_id.". Thanks!";
...
$sql2 = "UPDATE `check_in` SET `room_name`='$_REQUEST[room_name]', `room`='$room_id' WHERE lodge_id='$lodge_id'";

$sql3="UPDATE `active_check_in` SET `room_name`='$_REQUEST[room_name]', `room`='$room_id' WHERE lodge_id='$lodge_id'";
...
if($result2 && $result3) {
    echo "<script>alert('GUEST ROOM Changed Successfully')
