...
echo "<td><a href='paycharges.php?id=$row[id]' title='Pay Now'><button type='button' class='btn btn-outline btn-danger btn-xs' onclick='return confirm(Are you sure to pay this bill?)'>Pay Now </button></a></td>";
} else{
