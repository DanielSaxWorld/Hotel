...
$sql1="INSERT INTO check_out (date, lodge_id, uin, fullname, phone, checkout_date, arrival_date, room, room_name, amount) VALUES ('$day','$lodge_id','$uin','$fullname','$phone','$checkout_date','$arrival_date','$room','$room_name','$amount')";

$sql3="UPDATE `check_in` SET status='Checked-Out', total_amount='$newtotalamount' WHERE `uin`='$uin' ";

$sql2 = "DELETE FROM `active_check_in` WHERE `uin`='$uin'";

$sql4="UPDATE `room` SET `room_status`='Available', `lodge_id`='', `uin`='', `fullname`='' WHERE room_id=$room";
