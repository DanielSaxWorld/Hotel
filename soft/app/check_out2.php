...
$newtotalamount =$row['total_amount'];
$day=date("Y-m-d");
    ...
    $message= "Thanks ".$fullname." for patronizing us at Imperial Boni Hotels & Resorts, we hope to see you again soon!";
...
$sql1="INSERT INTO check_out (date, lodge_id, uin, fullname, phone, checkout_date, arrival_date, room, room_name, amount) VALUES ('$day','$lodge_id','$uin','$fullname','$phone','$checkout_date','$arrival_date','$room','$room_name','$newtotalamount')";

$sql3="UPDATE `check_in` SET status='Checked-Out', total_amount='$newtotalamount' WHERE `lodge_id`='$lodge_id' ";

$sql2 = "DELETE FROM `active_check_in` WHERE `lodge_id`='$lodge_id'";

$sql4="UPDATE `room` SET `room_status`='Available', `lodge_id`='', `uin`='', `fullname`='', `phone`='' WHERE room_id=$room";
...
if($result2 && $result && $result4) {

        echo "<script>alert('Guest Successfully Checked Out')
location.href='guest_profile.php?uin=".$_REQUEST['uin']."' </script>";
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group col-lg-6">
                                               ...
                                               <select name="lodge_id" class="form-control" required readonly>

     <option value="<?php echo $_REQUEST['lodge_id'] ?>"> <?php echo $_REQUEST['lodge_id'] ?> </option>
                    </select>
                                            </div>
