...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Check-In Report by Date</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="25"> <?php echo $session_business_name; ?> | Check-In Report by Date</h5>
...
?>
                    ...
                    <tbody>
<?php
 $sql = "SELECT *, sum(total_amount) as GRAND_amount FROM check_in WHERE `date` BETWEEN '$datefrom' AND '$dateto'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
