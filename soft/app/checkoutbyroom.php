...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Check-Out Report by Rooms</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="25"> <?php echo $session_business_name; ?> | Check-Out Report by Rooms</h5>
...
$sql = "SELECT * FROM `check_out` WHERE `room_name`='$room' AND `date` BETWEEN '$datefrom' AND '$dateto'";
