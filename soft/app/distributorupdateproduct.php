                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5><img src="img/hgl_logo.fw.png" height="30"> Distributor Update Product </h5>
...
$sql = "UPDATE pro_distributor SET product_code='$code', gen_name='$stock2', product_name='$name', o_price='$o_price', price='$price', wsprice='$wsprice', qty='$totalstock', date_arrival='$date_arrival', reorder_level='$reorder_level' WHERE product_id=$_REQUEST[product_id]";
...
$num=mysqli_insert_id($conn);
	...
	echo "<script>alert('Distributor Product Successfully Updated')
location.href='distributor_inventory.php'</script>";
	}
...
?>
                    ...
                    <div class="col-lg-9">
                    <input type="text" name="code" placeholder="Brand Name" value="<?php echo $row['product_code']; ?>" class="form-control" required>
                    </div>
                    </div>
...
document.getElementById("totalstock").value=sum2stock;
                    ...
                    <div class="col-lg-9">
                    <input type="text" name="reorder_level" step="any" value="<?php echo $row['reorder_level']; ?>"  placeholder="Re-Order Level"  class="form-control" readonly required>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                    <input type="date" name="date_arrival" value="<?php echo $row['date_arrival']; ?>" placeholder="Purchase Date" class="form-control" required title="Purchase Date">
                    </div>
                    </div>
...
document.getElementById("profit2").value=sum2;
                    ...
                    <div class="col-lg-9">
                    <input type="number" name="o_price" step="any" id="o_price2" onkeyup="sum()" value="<?php echo $row['o_price']; ?>" placeholder="Purchase Price" class="form-control" required>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                    <input type="number" name="wsprice" step="any" id="price3" value="<?php echo $row['wsprice']; ?>" onkeyup="sum()" placeholder="Wholesales Price" class="form-control" required>
                    </div>
                    </div>
