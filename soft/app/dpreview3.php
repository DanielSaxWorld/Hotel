...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Restuarant Sales Receipt</title>
...
<body>
    ...
    <?php include 'menus3.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    <h2> <img src="img/hgl_logo.fw.png" height="35"> <strong><?php echo $session_business_name; ?> | Restuarant Sales Receipt</strong></h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="restaurants.php">Dashboard</a>
                        </li>
                        <li class="active">
                            <strong>Restuarant Sales Receipt</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <div class="title-action">
                    <a href="sales3.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Sales</button></a>



						 <a <?php echo "href='dpreview3_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> XP-90 </a>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <table class="table table-striped">
                             <thead>
                             <tr>
                             <td align="center" colspan="5"><h3>Restuarant SALES RECEIPT</h3></td>
                             </tr>
