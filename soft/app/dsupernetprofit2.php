...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Distributor Net Profit</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="25"> <?php echo $session_business_name; ?> | Distributor Net Profit Report</h5>
...
<?php  
 $sql = "SELECT *, sum(amount) as TOTAL_amountSALES FROM dsales_order WHERE `date` BETWEEN '$datefrom' AND '$dateto'";
...
while($row = mysqli_fetch_array($result)) {
   ...
   echo	'
   <tr>
<th colspan="2">TOTAL GROSS SALES: ' . "<span class='value-$TOTAL_amountSALES'>&#8358;" . number_format($row['TOTAL_amountSALES'], 2) . "</span>" .'</th>
</tr>';
...
<?php  
 $sql = "SELECT *, sum(profit) as TOTAL_profitSALES FROM dsales_order WHERE `date` BETWEEN '$datefrom' AND '$dateto'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
...
<tr>
<th colspan="2">TOTAL GROSS PROFIT: ' . "<span class='value-$TOTAL_profitSALES'>&#8358;" . number_format($row['TOTAL_profitSALES'], 2) . "</span>" .'</th>
</tr>';
...
<?php  
 $sql = "SELECT *, sum(amount) as TOTAL_opexAMOUNT FROM dopex WHERE `opex_date` BETWEEN '$datefrom' AND '$dateto'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
...
<?php
   $totalexpensis = $_REQUEST['TOTAL_opexAMOUNT'];
