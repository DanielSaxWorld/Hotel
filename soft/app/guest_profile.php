...
th { text-align:right}
                    ...
                    <th style="text-align:left">Staff Name</th>
                        ...
                        <th style="text-align:left">Room</th>
                         ...
                         <th style="text-align:left">Night(s)</th>
                         <th style="text-align:left">Purpose</th>
                         <th style="text-align:left">Arrived From</th>
...
<tr>
<th colspan="13" style=" text-align:right">GRAND TOTAL ON CHECK-IN </th>
...
?>
                    ...
                    <tbody>
<?php
$sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as charges_date FROM charges WHERE uin='$_REQUEST[uin]' ORDER BY date ASC";
$result = mysqli_query($conn, $sql);
if (mysqli_num_rows($result) > 0) {
	 while($row = mysqli_fetch_array($result)) {
?>
