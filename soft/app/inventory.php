...
<body>
   ...
   <?php  include 'menus.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><img src="img/hgl_logo.fw.png" height="30"> <strong><?php echo $session_business_name; ?> INVENTORY</strong></h2>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php echo $session_business_name; ?> | Inventory</h5>
                    ...
                    <tr class="gradeA">
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                             ...
                             <li><a data-toggle="modal" <?php echo "href='updateproduct.php?product_id=".$row['product_id']."'"; ?>>Edit</a></li>
                            </ul>
                        </div></td>
                    </tr>
