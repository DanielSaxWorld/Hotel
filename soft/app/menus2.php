                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                           <li><a href="staff_dash.php">Go to Dashboard</a></li>
...
<li class="active"><a href="sales2.php?id=cash&invoice=<?php echo $finalcode ?>">Add Retail Sales</a>  </li>
	<li class="active"><a href="bulksales2.php?id=cash&invoice=<?php echo $finalcode2 ?>">Add Wholesales</a> </li>
