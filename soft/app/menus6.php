...
<div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                           <li><a href="receptionist.php">Go to Dashboard</a></li>
                    ...
                    <li class="active"><a href="new_guest2.php">Add Guest <span class="label label-primary pull-right">NEW</span></a> </li>
						<li class="active"><a href="guest_view2.php">View all Guest</a> </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                    <li class="active"><a href="reservation2.php">Add Reservation <span class="label label-primary pull-right">NEW</span></a> </li>
						<li class="active"><a href="view_reservation2.php">View all Reservation</a> </li>
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" method="post" action="search6.php">
...
startTime();
 ...
 <div class="modal inmodal col-xs-12" id="checkoutbydate" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <h3><i class="fa fa-map-marker"></i> Check-Out Report by Date</h3><hr>
                    <form class="form-horizontal" method="post" action="checkoutbydate2.php">
        ...
        <div class="modal-dialog">
            <div class="modal-content animated flipInY">
                <div class="modal-header">
                    ...
                    <hr>
                    <form class="form-horizontal" method="post" action="checkoutbyroom2.php">
...
if (mysqli_num_rows($result2) > 0) {
    ...
    <div class="modal inmodal col-xs-12" id="checkinbydate" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <h3><i class="fa fa-map-marker"></i> Check-In Report by Date</h3><hr>
                    <form class="form-horizontal" method="post" action="checkinbydate2.php">
        ...
        <div class="modal-dialog">
            <div class="modal-content animated flipInY">
                <div class="modal-header">
                    ...
                    <hr>
                    <form class="form-horizontal" method="post" action="checkinbyroom2.php">
...
if (mysqli_num_rows($result2) > 0) {
 ...
 <div class="modal inmodal col-xs-12" id="checkinbystatus" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <h3><i class="fa fa-map-marker"></i> Check-In Report by Status</h3><hr>
                    <form class="form-horizontal" method="post" action="checkinbystatus2.php">
    ...
    <div class="modal inmodal col-xs-12" id="checkinmodeofpayment" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <h3><i class="fa fa-map-marker"></i> Check-In Report by Payment Mode</h3><hr>
                    <form class="form-horizontal" method="post" action="checkinmodeofpayment2.php">
	...
	while($row = mysqli_fetch_array($result2)) {
     ...
     <option value="<?php echo $row['product_code'] ?>"> <?php echo $row['product_code'] ?> </option><?php } }?>
                    ...
                    <input type="submit" name="inventorybydate" value="Generate Report" class="btn btn-danger">
                            ...
                            <!--Add Opex Line-->
        <div class="modal inmodal col-xs-12" id="postcharges" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated flipInY">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          <h3><i class="fa fa-calculator"></i> Post Guest Charges</h3><hr>
                    <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    <?php
include("db_conn.php");
...
$sql1="INSERT INTO charges (opex_id, opex_date, purpose, description, amount, c_o) VALUES ('$opex_id','$opex_date','$purpose','$description','$amount','$c_o')";
...
$num=mysqli_insert_id($conn);
	...
	echo "<script>alert('Guest Charges Successfully Added')
...
?>
                    ...
                    <div class="col-lg-12">
                    <input type="submit" name="postcharges" value="Post Charges" onclick="return confirm('Are you sure to Post Guest Charges?');" class="btn btn-primary">
                    </div>
                    </form>
