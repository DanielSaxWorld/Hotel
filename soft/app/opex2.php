            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                    <div class="title-action">
                        <a data-toggle="modal" data-target="#addopex2" class="btn btn-primary" style="float:right"><i class="fa fa-plus-circle"></i> Add Opex</a>
                    </div>
                </div>
            </div>
...
$sql = "SELECT *, DATE_FORMAT(opex_date, '%a-%d-%b-%Y') as Newopexdate FROM `opex` WHERE `opex_date`='$current_today' ORDER by id ASC  LIMIT 30";
