...
<head>
    ...
    <title><?php echo $session_business_name; ?> | BAR Opex</title>
...
<body>
   ...
   <?php  include 'menus4.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><img src="img/hgl_logo.fw.png" height="30"> <strong>BAR OPERATING EXPENSIS</strong></h2>
                    <ol class="breadcrumb">
                        <li>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php
include('db_conn.php');
$sql = "SELECT *, DATE_FORMAT(opex_date, '%a-%d-%b-%Y') as Newopexdate FROM `sopex` ORDER by id ASC  LIMIT 30";
                    ...
                    <tr class="gradeA">
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a <?php echo "href='ddelete_record4.php?id=".$row['id']."' title='Delete Opex'"; ?> onclick="return confirm('ARE YOU SURE TO DELETE THIS RECORD!'); ">Delete</a></li>
