...
<button type="submit" class="btn btn-primary" style="width: 160px; height:35px; margin-top:-5px; border-radius:5px" /><i class="fa fa-shopping-cart"></i> Add SR Order</button>
</form>
