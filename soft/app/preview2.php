...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Retail Sales Receipt</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Retail Sales Receipt</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <div class="title-action">
                    <a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Retail Sales</button></a>
                        <a <?php echo "href='preview2_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Receipt </a>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <table class="table table-striped">
                             <thead>
                             <tr>
                             <td align="center" colspan="5"><h3>RETAIL SALES RECEIPT</h3></td>
                             </tr>
