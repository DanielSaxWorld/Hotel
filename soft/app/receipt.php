...
<body>
    ...
    <?php include 'm_menus.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    <div class="title-action">
                        <a <?php echo "href='receipt_print.php?lodge_id=".$_REQUEST['lodge_id']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Receipt </a>
                    </div>
                </div>
            </div>
        <div class="row">
       ...
       <td><?php echo $row['fullname']; ?></td>
        ...
        <tr>
       <td><div style="float:right"><strong>Arrival Date:</strong></div></td>
       <td><?php echo date('d-M-Y', strtotime($row['arrival_date'])); ?></td>
       </tr>

        <tr>
       <td><div style="float:right"><strong>Checkout Date:</strong></div></td>
       <td><?php echo date('d-M-Y', strtotime($row['checkout'])); ?></td>
       </tr>

        <tr>
       <td><div style="float:right"><strong>Purpose of Visit:</strong></div></td>
       <td><?php echo $row['purpose']; ?></td>
       </tr>

        <tr>
       <td><div style="float:right"><strong>No of Guest(s):</strong></div></td>
       <td><?php echo $row['nofguest']; ?></td>
       </tr>

        <tr>
       <td><div style="float:right"><strong>Arrived From:</strong></div></td>
       <td><?php echo $row['arrived_from']; ?></td>
       </tr>
