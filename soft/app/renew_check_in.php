...
if($result && $result3 && $result4 && $result5) {
    ...
    echo "<script type='text/javascript'>location.href='receipt.php?lodge_id=".$lodge_id."';</script>";
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input name="room_price" value="<?php echo $row['room_price']; ?>" placeholder="Room Price" type="text" step="any"  onkeyup="calroom()" class="form-control" id="price" readonly>
                                            </div>
...
var sum2 = (price*nights-discount).toFixed(2);
...
document.getElementById("total_amount").value=sum2;
    ...
    <div class="form-group col-lg-6">
    <label>Discount in Amount <span style="color: red;">(e.g 1000)</span> *</label>
