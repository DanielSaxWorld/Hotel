...
$sql1="INSERT INTO loan_repayment (loan_id, uin, fullname, loan_type, loan_amount, loan_deductable, payment_method, bank, teller_no, payment_date, loan_balance) VALUES ('$loan_id','$uin','$fullname','$loan_type','$loan_amount','$loan_amount_payment','$payment_method','$bank','$teller_no','$payment_date','$loan_balance')";
...
function sum()
{
var previous_loan_balance = parseInt(document.getElementById("previous_loan_balance").value);
var loan_amount_payment = parseInt(document.getElementById("loan_amount_payment").value);


if(previous_loan_balance.value=="")
{
previous_loan_balance.value = 0.00;
}
...
var sum = (previous_loan_balance-loan_amount_payment).toFixed(2);
document.getElementById("loan_balance").value=sum;
}
</script>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group col-lg-6">
                                             ...
                                             <div class="form-group col-lg-6">
                                                ...
                                                <input name="previous_loan_balance" value="<?php echo $row['loan_balance']; ?>" placeholder="Previous Loan Balance" readonly  type="number" step="any" id="previous_loan_balance" onkeyup="sum()" class="form-control required">
                                            </div>
                                             <div class="form-group col-lg-6">
                                                <label>Loan Amount Payment *</label>
                                                <input name="loan_amount_payment" placeholder="Loan Amount Payment" type="number" step="any" id="loan_amount_payment" onkeyup="sum()" class="form-control required">
                                            </div>
                                             <div class="form-group col-lg-6">
                                            ...
                                            <div class="form-group col-lg-6">
                                             ...
                                             <div class="form-group col-lg-6">
              <label>New Loan Balance</label>
              <?php //$loan_balance= $row['loan_balance'] - $row['loan_deductable']; 
		  
			  ?>
              <input type="number" step="any" id="loan_balance" onkeyup="sum()" readonly placeholder="Loan Balance"   class="form-control" title="Loan Balance" name="loan_balance">
          </div>
