...
<head>
    ...
    <title>CLASSIC GLOBAL COMMUNICATIONS | Return by Date</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><img src="img/hgl_logo.fw.png" height="25"> CLASSIC GLOBAL COMMUNICATIONS | Return Report by Date</h5>
...
$sql = "SELECT *, DATE_FORMAT(returndate, '%a-%d-%b-%Y') as newreturndate FROM `return` WHERE `returndate` BETWEEN '$datefrom' AND '$dateto'";
