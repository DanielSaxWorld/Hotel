...
$sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newsalesdate FROM `sales_order` WHERE `date` BETWEEN '$datefrom' AND '$dateto' ORDER by 'transactions_id'";
...
?>
                    ...
                    <tbody>
<?php
 $sql = "SELECT *, sum(amount) as TOTAL_amount, sum(qty) as TOTAL_qty FROM sales_order WHERE `date` BETWEEN '$datefrom' AND '$dateto'";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'SUPERMARKET_SalesbyDate'},
                    {extend: 'pdf', title: 'SUPERMARKET_SalesbyDate'},
