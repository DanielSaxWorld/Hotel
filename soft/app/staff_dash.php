    ...
    <?php include 'menus2.php'; ?>
                ...
                <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-sm-12">
                        ...
                        <a href="sales2.php?id=cash&invoice=<?php echo $finalcode ?>"> <div class="col-lg-6">
            ...
            <a href="bulksales2.php?id=cash&invoice=<?php echo $finalcode2 ?>"> <div class="col-lg-6">
            ...
            <!-- <a href="staffbulksales2.php?id=cash&invoice=<?php// echo $finalcode3 ?>"> <div class="col-lg-3">
                <div class="widget style1 lazur-bg">
                    <div class="row">
                       <div class="col-xs-4">
                        ...
                        <div class="col-xs-8 text-left">
                            <span> Add Bulk Sales</span>
                            <h2 class="font-bold" style="font-size: 24px">Bulk Sales</h2>
                        </div>
                    </div>
                </div>
            </div></a> -->
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
				...
				toastr.success('Staff Dashboard', 'Welcome to <?php echo $session_business_name; ?>');
