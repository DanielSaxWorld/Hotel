...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Bulk Sales Receipt</title>
...
<body>
    ...
    <?php include 'menus2.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    <h2> <img src="img/hgl_logo.fw.png" height="35"> <strong><?php echo $session_business_name; ?> | Bulk Sales Receipt</strong></h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="staff_dash.php">Dashboard</a>
                        </li>
                        <li class="active">
                            <strong>Bulk Sales Receipt</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <div class="title-action">
                    <a href="staffbulksales2.php?id=cash&invoice=<?php echo $finalcode3 ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Bulk Sales</button></a>

						 <a <?php echo "href='staffbulkpreview2_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> HP A4 </a>

                         <a <?php echo "href='preview3_printRT.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-danger"><i class="fa fa-print"></i> XP-90 </a>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <table class="table table-striped">
                             <thead>
                             <tr>
                             <td align="center" colspan="5"><h3>BULK SALES RECEIPT</h3></td>
                             </tr>
