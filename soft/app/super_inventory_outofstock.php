...
<body>
   ...
   <?php  include 'super_menus.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><img src="img/hgl_logo.fw.png" height="30"> <strong><?php echo $session_business_name; ?> INVENTORY OUT OF STOCK</strong></h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Inventory Out of Stock</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php echo $session_business_name; ?> | Inventory Out of Stock</h5>
                    ...
                    <?php
include('db_conn.php');
$sql = "SELECT *, DATE_FORMAT(date_arrival, '%a-%d-%b-%Y') as Newpurchasedate FROM `products` WHERE qty=0 ORDER by product_id ASC";
$result = mysqli_query($conn, $sql);
