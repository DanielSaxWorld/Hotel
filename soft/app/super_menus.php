...
$finalcode = 'IBH-' . $randtime.$randday.$rand;
?>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-university"></i> <span class="nav-label">Reservation</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                    <li class="active"><a href="reservation.php">Add Reservation <span class="label label-primary pull-right">NEW</span></a> </li>
						<li class="active"><a href="view_reservation.php">View all Reservation</a> </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="suspend_all_account.php">Suspend All Login</a></li>
						<li><a href="activate_all_account.php">Activate All Login</a></li>
...
$sql="INSERT INTO staff_id (staff_id, fullname, email, phone, password, station, designation, business_name, business_phone, business_address, passport, status) VALUES ('$staff_id','$fullname','$email','$phone',PASSWORD('$passwordreg'),'$station','$designation','$business_name','$business_phone','$business_address','$passport','Active')";
...
//                                     <h2 style='font-size: 18px; color: #077CC0; font-weight: 600; margin: 0;'>Imperial Boni Hotels & Resorts Login Account Creation </h2>
//                                 </td>
//                             </tr>
//                             <tr>
...
// 									<p style='margin-bottom: 10px;'><b>Password: $passwordreg</b></p>
...
// 									<p style='margin-bottom: 10px;'><em>Powered by <a href='https://wetindey.space' target='_blank'><strong>Wetin Dey Inc.</strong></a></em><br><br>
...
//                                     <p style='font-size: 13px;'>Copyright © 2022 <strong>Imperial Boni Hotels & Resorts</strong>. All rights reserved. <br> </p>

//                                     <p style='padding-top: 15px; font-size: 12px;'>This email was sent to you as a registered $designation on <a style='color: #077CC0; text-decoration:none;' href='#'><strong>Imperial Boni Hotels & Resorts Portal</strong></a>.</p>
//                                 </td>
//                             </tr>
//                         </tbody>
//                     </table>
...
//}
	...
	mysqli_close($conn);
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Imperial Boni Hotels & Resorts" readonly name="business_name" placeholder="Enter Business Name">
                            </div>
                        </div>

                        <input  type="hidden" value="+234-905-965-9790" readonly name="business_phone" placeholder="Enter Business Phone No">
