    ...
    <?php include 'super_menus.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="superbulksales.php?id=cash&invoice=<?php echo $finalcode2 ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Wholesales</button></a>
                        <a <?php echo "href='superbulkpreview2_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> HP A4 </a>

                        <a <?php echo "href='superbulkpreview2_printws.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-danger"><i class="fa fa-print"></i> XP-90 </a>
