    ...
    <?php include 'super_menus.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="superbulksales2.php?id=cash&invoice=<?php echo $finalcode3 ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Bulk Sales</button></a>

                    <a <?php echo "href='superbulkpreview222_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> HP A4 </a>

                        <a <?php echo "href='superbulkpreview2_printRT.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-danger"><i class="fa fa-print"></i> XP-90 </a>
