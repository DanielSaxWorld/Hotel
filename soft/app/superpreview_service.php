    ...
    <?php include 'super_menus.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="superservices2.php?id=cash&invoice=<?php echo $finalcode2 ?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to Services</button></a>
                        <a <?php echo "href='superpreviewservice2_print.php?invoice=".$_GET['invoice']."'"?> target="_blank" class="btn btn-danger"><i class="fa fa-print"></i> Print Receipt </a>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <table class="table table-striped">
                             <thead>
                             <tr>
                             <td align="center" colspan="5"><h3>SERVICE RECEIPT</h3></td>
                             </tr>
