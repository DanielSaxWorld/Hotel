...
?>
                    ...
                    <tbody>
<?php
 $sql = "SELECT *, sum(amount) as TOTAL_amount, sum(qty) as TOTAL_qty, sum(profit) as TOTAL_profit FROM sales_order WHERE `date` BETWEEN '$datefrom' AND '$dateto' AND product_code='$productcode' ";
$result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_array($result)) {
