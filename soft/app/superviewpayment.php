            ...
            <div class="row wrapper border-bottom white-bg page-heading">
				...
				<div class="col-lg-2">
                    <div class="title-action">
                        ...
                        <a <?php echo "href='superaddrepayment.php?invoice_number=".$_REQUEST['invoice_number']."' title='Add Repayment'"; ?> class="btn btn-danger" style="float:right" target="_blank"><i class="fa fa-plus-circle"></i> Add Repayment</a>
                    </div>
                </div>
