...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Update Services</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5><img src="img/hgl_logo.fw.png" height="30"> Update Service </h5>
...
$sql = "UPDATE service SET product_code='$code', price='$price', date_arrival='$date_arrival' WHERE product_id=$_REQUEST[product_id]";
...
$num=mysqli_insert_id($conn);
	...
	echo "<script>alert('Service Successfully Updated')
...
?>
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="date" name="date_arrival" value="<?php echo $row['date_arrival']; ?>" placeholder="Purchase Date" class="form-control" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="price" value="<?php echo $row['price']; ?>" placeholder="Service Price" class="form-control" required="required">
                            </div>
                        </div>
			...
			?>
                    ...
                    <input type="submit" name="updateproduct" value="Update Service" class="btn btn-danger">
                    </div>
                    </form>
                        </div>
                    </div>
