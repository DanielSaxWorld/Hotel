...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Reservation List</title>
...
<body>
   ...
   <?php  include 'super_menus.php'; ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><strong><?php echo $session_business_name; ?> | ALL RESERVATION LIST</strong></h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong><?php echo $session_business_name; ?> | All Reservation List</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php echo $session_business_name; ?> | All Reservation List</h5>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'AA_Guest_List'},
                    {extend: 'pdf', title: 'AA_Guest_List'},
