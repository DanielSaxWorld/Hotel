...
<head>
    ...
    <title><?php echo $session_business_name; ?> | Sales Rep Inventory</title>
...
$sql = "SELECT * FROM products_salesrep WHERE salesrep_id='$_REQUEST[salesrep_id]'";
...
?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><img src="img/hgl_logo.fw.png" height="30"> <strong><?php echo $row['fullname']; ?> | SALES REP INVENTORY</strong></h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Sales Rep Inventory</strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="col-lg-2">
                    ...
                    <div class="title-action">
						<a href="salesrep.php"><button class="btn btn-info"><i class="fa fa-arrow-left"></i></button></a> &nbsp;
                        <a data-toggle="modal" <?php echo "href='addsalesrep_product.php?salesrep_id=".$_REQUEST['salesrep_id']."'"; ?> class="btn btn-primary" style="float:right"><i class="fa fa-plus-circle"></i> &nbsp; Add Product</a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php echo $row['fullname']; ?> | Sales Rep Inventory</h5>
