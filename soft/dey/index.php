...
$sql="INSERT INTO staff_id (staff_id, fullname, email, phone, password, station, designation, business_name, business_phone, business_address, passport, status) VALUES ('$staff_id','$fullname','$email','$phone',PASSWORD('$password2'),'$station','$designation','$business_name','$business_phone','$business_address','$passport','Active')";
...
//                                     <h2 style='font-size: 18px; color: #9E7256; font-weight: 600; margin: 0;'>Imperial Boni Hotels & Resorts Login Account Creation </h2>
//                                 </td>
//                             </tr>
//                             <tr>
...
//                                     <p style='padding-top: 15px; font-size: 12px;'>This email was sent to you as a registered $designation on <a style='color: #9E7256; text-decoration:none;' href='#'><strong>Imperial Boni Hotels & Resorts Portal</strong></a>.</p>
//                                 </td>
//                             </tr>
//                         </tbody>
//                     </table>
